...
export default function Chat() {
  ...
  const composeInput = () => {
    ...
    const sentence = `Give me a tarot reading about my ${subject}. I pulled the following cards from left to right: ${cards.join(
      ", "
  ...
  return (
    <div className="flex flex-col w-full max-w-xl py-24 pb-56 mx-auto stretch gap-8">
      ...
      {messages?.[messages.length - 1]?.role === "assistant" &&
        irmaiIsSpeaking && <span className="font-bold">Speaking now</span>}
